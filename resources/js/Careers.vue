    ...
    <div class="min-h-screen">
        ...
        >
            ...
            >
                <div class="text-center">
                    ...
                    >
                        Careers at <span class="gradient-text">Mount Agro</span>
                    </h1>
                    <p
                        class="text-xl md:text-2xl text-green-100 mb-8 max-w-3xl mx-auto animate-fadeInUp"
                        style="animation-delay: 0.2s"
                    >
                        Join our mission to advance technology solutions and
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                        Discover what makes Mount Agro a great place to build
                        your career
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    >
                        ...
                        <p class="text-gray-600">
                            Make a real difference in the lives of businesses
                            and entrepreneurs through innovative technology
                            solutions
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <p class="text-gray-600">
                            ...
                            and inclusive environment that values teamwork
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <p class="text-gray-600">
                            Develop your skills and advance your career in the
                            technology sector with continuous learning
                            opportunities
                        </p>
                    </div>
                </div>
        ...
        <section class="section-padding bg-gradient-bg-organic">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                        Explore exciting career opportunities and find your next
                        role at Mount Agro
                    </p>
                </div>
        ...
        <section class="section-padding bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                        Our streamlined hiring process ensures we find the right
                        fit for both you and our team
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div class="text-center">
                        <div
                            class="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center text-white font-bold text-xl bg-gradient-to-br from-green-600 to-emerald-600"
                        >
                            1
                        </div>
                        ...
                        <p class="text-sm text-gray-600">
                            Send your CV and cover letter through our
                            application portal
                        </p>
                    </div>
                    <div class="text-center">
                        <div
                            class="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center text-white font-bold text-xl bg-gradient-to-br from-emerald-600 to-green-600"
                        >
                            2
                        </div>
                        <h3 class="font-semibold mb-2 text-gray-900">
                        ...
                        <p class="text-sm text-gray-600">
                            Our HR team reviews your application and
                            qualifications
                        </p>
                    </div>
                    <div class="text-center">
                        <div
                            class="w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center text-white font-bold text-xl bg-gradient-to-br from-yellow-500 to-orange-500"
                        >
                            3
                        </div>
                        <h3 class="font-semibold mb-2 text-gray-900">
                        ...
                        <p class="text-sm text-gray-600">
                            Meet with our team for a comprehensive technical and
                            cultural interview
                        </p>
                    </div>
                    <div class="text-center">
                        ...
                        <p class="text-sm text-gray-600">
                            Receive feedback and join our team if selected
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="text-center mb-16">
                    ...
                    <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                        ...
                        members' well-being and career growth
                    </p>
                </div>
                ...
                >
                    <div
                        class="text-center p-6 rounded-professional-lg bg-white card-hover"
                    >
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-green-600 to-emerald-600 rounded-lg flex items-center justify-center mx-auto mb-4"
                        >
                            <svg
                        ...
                        <p class="text-sm text-gray-600">
                            Market-competitive compensation packages with
                            performance bonuses
                        </p>
                    </div>
                    <div
                    ...
                    >
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-emerald-600 to-green-600 rounded-lg flex items-center justify-center mx-auto mb-4"
                        >
                            <svg
                                class="w-6 h-6 text-white"
                                fill="none"
                    ...
                    >
                        <div
                            class="w-12 h-12 bg-gradient-to-br from-yellow-500 to-orange-500 rounded-lg flex items-center justify-center mx-auto mb-4"
                        >
                            <svg
                                class="w-6 h-6 text-white"
                                fill="none"
                        ...
                        <p class="text-sm text-gray-600">
                            Comprehensive health coverage for you and your
                            family members
                        </p>
                    </div>
                    <div
                    ...
                    >
                        ...
                        <p class="text-sm text-gray-600">
                            Flexible working arrangements and generous paid time
                            off policies
                        </p>
                    </div>
                </div>
        ...
        >
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                <h2 class="heading-lg mb-6">Ready to Join Our Team?</h2>
...
const jobs = [
    {
        ...
        posted: "2 days ago",
        description:
            "Lead development of cutting-edge software solutions using modern technologies and best practices.",
    ...
    },
    {
        ...
        posted: "1 week ago",
        description:
            "Manage cloud infrastructure, CI/CD pipelines, and ensure system reliability and scalability.",
    ...
    },
    {
        ...
        posted: "3 weeks ago",
        description:
            "Drive product strategy, roadmap development, and cross-functional team collaboration.",
        skills: [
            "Product Strategy",
            "Agile",
            "Analytics",
