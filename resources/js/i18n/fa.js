export default {
    ...
    // Loader translations
    "loader.home": "به کوه آگرو خوش آمدید",
    "loader.our_work": "کشف تأثیر ما",
    "loader.training_programs": "آماده‌سازی برنامه‌های آموزشی",
    "loader.agri_tech": "بارگذاری فناوری کشاورزی",
    "loader.market_access": "دسترسی به فرصت‌های بازار",
    "loader.smart_farming": "اتصال به راه‌حل‌های هوشمند",
    "loader.seed_supply": "آماده‌سازی اطلاعات تامین بذر",
    "loader.community_programs": "بارگذاری برنامه‌های جامعه",
    "loader.environmental_projects": "دسترسی به پروژه‌های محیط زیستی",
    "loader.resources": "جمع‌آوری منابع",
    "loader.careers": "آماده‌سازی فرصت‌های شغلی",
    "loader.contact": "بارگذاری اطلاعات تماس",
    "loader.default": "در حال بارگذاری صفحه",
    "loader.sub_home":
        "کشف راه‌حل‌های نوآورانه کشاورزی و شیوه‌های پایدار کشاورزی",
    "loader.sub_our_work": "نمایش تعهد ما به تحول کشاورزی در افغانستان",
    "loader.sub_training_programs": "آماده‌سازی برای اشتراک دانش و تقویت ظرفیت",
    "loader.sub_agri_tech":
        "ارائه ابزارها و فناوری‌های پیشرفته برای کشاورزی مدرن",
    "loader.sub_market_access": "گشودن درها به سوی فرصت‌ها و ارتباطات جدید",
    "loader.sub_smart_farming": "ادغام فناوری با خرد کشاورزی سنتی",
    "loader.sub_seed_supply": "اطمینان از نهاده‌های با کیفیت برای عملکرد بهتر",
    "loader.sub_community_programs": "اتصال جوامع و ایجاد مشارکت",
    "loader.sub_environmental_projects":
        "ترویج شیوه‌های پایدار برای آینده بهتر",
    "loader.sub_resources": "گردآوری انتشارات، اخبار و داستان‌های موفقیت",
    "loader.sub_careers": "یافتن استعداد مناسب برای رشد با ما",
    "loader.sub_contact": "ارتباط با تیم ما",
    "loader.sub_default": "لطفاً صبر کنید تا همه چیز را برای شما آماده کنیم",
};
