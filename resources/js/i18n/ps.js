export default {
    ...
    // Welcome
    "home.welcome.title": "د افغانستان کرنیز راتلونکی پیاوړی کوو",
    "home.welcome.body":
        "په مونټ اګرو کې موږ د نوښت، زده‌کړې او دوامدارو کرنیزو خدمتونو له لارې کلیوالې ټولنې پیاوړې کوو — ترڅو بزګران د وقار، سوکالۍ او د ځمکې د ساتنې احساس سره وده وکړي.",
    // About
    ...
    "home.foundation.vision.body":
        " د افغانستان کرنه په یو ځیرک، دوامدار او ټول‌شموله سکتور بدلول، چې د خوړو امنیت، سوکالي او چاپېریالي توازن تامین کړي.",
    "home.foundation.mission.title": "ماموریت",
    "home.foundation.mission.body":
        " زموږ ماموریت د نوښت، روزنې او دوامدارو کرنیزو حل‌لارو له لارې د کروندګرو او کلیوالو ټولنو پیاوړتیا ده. موږ د تولید زیاتوالي، ارزښت‌زنځیر د پیاوړتیا او عادلانه بازارموندنې تر څنګ د چاپېریال ساتنې او ټولنیز ګډون ملاتړ کوو.",
    "home.foundation.values.title": "اساسي اصول",
    "home.foundation.values.body": ["مسلکیت", "کیفیت", "شفافیت"],
    // Pillars intro
    ...
    "home.cta.body":
        "زموږ په ماموریت کې له موږ سره یوځای شئ ترڅو د بزګرانو د ژوند ښه کولو او د افغانستان د کرنې سکتور پیاوړتیا له لارې د عصري کرنیزو حل لارو، ظرفیت جوړونې، او دوامدارې کرنې پرمختګ ملاتړ وکړو.",
