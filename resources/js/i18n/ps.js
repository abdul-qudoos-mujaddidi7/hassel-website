export default {
    ...
    create_job_announcement: "د دندو اعلان جوړول",
    edit_job_announcement: "د دندو اعلان سمول",
    location: "ځای",
    requirements: "اړتیاوې",
    salary_range: "د معاش حد",
    application_deadline: "د غوښتنلیک وخت",
    deadline: "وخت",
    ...
    "contact.get_in_touch": "اړیکه ونیسئ",
    "contact.head_office": "مرکزي دفتر",
    "contact.phone": "تلیفون",
    "contact.email": "بریښنالیک",
    "contact.business_hours": "د کار ساعات",
    "contact.follow_us": "زموږ تعقیب وکړئ",
    "contact.send_message": "پیغام واستوئ",
    "contact.first_name": "نوم",
    "contact.last_name": "د کورنۍ نوم",
    "contact.email_address": "د بریښنالیک پته",
    "contact.phone_number": "د تلیفون شمیره",
    "contact.subject": "موضوع",
    "contact.select_subject": "موضوع وټاکئ",
    "contact.job_application": "د دندې غوښتنه",
    "contact.general_inquiry": "عمومي پوښتنه",
    "contact.project_discussion": "د پروژې بحث",
    "contact.technical_support": "تخنیکي ملاتړ",
    "contact.partnership": "شریکوالی",
    "contact.media_inquiry": "د رسنیو پوښتنه",
    "contact.other": "نور",
    "contact.job_application_details": "د دندې غوښتنې جزئیات",
    "contact.job_title": "د دندې نوم",
    "contact.your_location": "ستاسو ځای",
    "contact.cover_letter": "د پوښتنې لیک",
    "contact.cv_resume_upload": "د سی وی/رزومې پورته کول",
    ...
    "file_type.docx": "د Word سند",
    "file_type.xls": "د Excel جدول",
    "file_type.xlsx": "د Excel جدول",
    "file_type.ppt": "د PowerPoint ارائه",
    "file_type.pptx": "د PowerPoint ارائه",
    "file_type.txt": "د متن فایل",
    "file_type.other": "نور",
    "file_type.manual": "لارښود",
    "file_type.report": "راپور",
    "file_type.guideline": "د عملیاتو لارښود",

    "home.hero.title": "د کرنیزو ټولنو د پیاوړتیا",
    "home.hero.subtitle": "د نوښت او روزنې له لارې د پایدار راتلونکي جوړول",
    "home.hero.contact": "اړیکه ونیسئ",

    // Welcome
    "home.welcome.title": "ماونت اگرو ته ښه راغلاست",
    "home.welcome.body":
        "د افغانستان د کرنیزو ټولنو پیاوړتیا د نوښتګرې کوچنۍ مالي مرستې، هراړخیزو روزنیزو پروګرامونو او پایداره پرمختیایي نوښتونو له لارې. موږ د هېواد په کچه د لا پیاوړو او مقاومو کرنیزو ټولنو د جوړولو هوډ لرو.",
    ...
    // Stats labels
    "home.stats.beneficiaries": "ګټه اخیستونکي",
    "home.stats.programs_completed": "پروګرامونه بشپړ شول",
    "home.stats.provinces_reached": "ولایتونو ته رسیدلی",
    "home.stats.cooperatives_formed": "همکارۍ جوړې شوې",

    // Foundation
    "home.foundation.title": "زموږ بنسټ",
    ...
    "home.pillars.subtitle":
        "اووه اصلي ستنې چې زموږ ماموریت د افغانستان د کرنې چاپیریال د بدلون لپاره د هراړخیز ملاتړ او نوښتګر حل لارو له لارې پرمخ وړي.",

    // News
    "home.news.title": "وروستي خبرونه او تازه معلومات",
    "home.news.subtitle":
        "زموږ د نوو پروګرامونو، د بریا کیسو، او د افغانستان د کرنې سکتور پرمختګونو څخه خبر شئ.",
    "home.news.read_more": "نور ولولئ",
    "home.news.view_all": "ټول وګورئ",

    // Partners
    "home.partners.title": "زموږ شریکان",
    "home.partners.subtitle":
        "د حکومتي ادارو، غیر دولتي سازمانونو، او خصوصي سکتور له شریکانو سره ګډ کار د زموږ د اغېز د زیاتولو لپاره.",

    // Leadership
    "home.leadership.title": "د مشرتابه ټیم",
    "home.leadership.subtitle":
        "له هغو با تجربه مسلکي خلکو سره ووینئ چې زموږ ماموریت رهبري کوي.",
    "home.leadership.ceo_title": "اجرائیه رییس او بنسټ ایښودونکی",
    "home.leadership.ceo_desc": "ستراتیژیک رهبري، شریکوالي او د سازمان وده.",
    "home.leadership.programs_title": "د پروګرامونو رییس",
    "home.leadership.programs_desc":
        "د روزنې، بازار او ټولنې پروګرامونو طرحه او پلي کول.",
    "home.leadership.finance_title": "د مالي چارو رییس",
    "home.leadership.finance_desc":
        "مسلکي مالي سرپرستي او د مایکروفاینانس مسوولانه چارې.",

    // Closing CTA
    "home.cta.title": "چمتو یاست چې کرنیزې ټولنې بدل کړئ؟",
    "home.cta.body":
        "له موږ سره یوځای شئ ترڅو بزګران بااختیاره کړو او د افغانستان د کرنې سکتور د نوښتګر مایکروفاینانس حل لارو له لارې پیاوړی کړو.",
    "home.cta.get_started": "پیل وکړئ",

    // AgriTech Tools (list)
    "agritech.breadcrumb.home": "کور",
    "agritech.badge": "د ټکنالوژۍ حللارې",
    "agritech.title": "د کرنې تخنیکي وسایل",
    "agritech.subtitle":
        "د نوښتګرو کرنیزو ټکنالوژیو موندنه چې د کرنې طریقې ښه کوي، تولید زیاتوي او پایدار کرنې ته ملاتړ برابروي.",
    "agritech.stats.tools": "شته وسایل",
    "agritech.stats.platforms": "پلتفارمونه",
    "agritech.stats.free": "وړیا لاسرسی",
    "agritech.scroll": "ټول وسایل لاندې وګورئ",
    "agritech.filters.title": "وسایل فلټر کړئ",
    "agritech.filters.reset": "فلټرونه بیا تنظیم کړئ",
    "agritech.filters.type": "د وسیلې ډول",
    "agritech.filters.type_all": "ټول ډولونه",
    "agritech.filters.type_mobile_app": "موبایل اپ",
    "agritech.filters.type_web_tool": "وېب وسیله",
    "agritech.filters.type_desktop_software": "ډیسکتاپ سافټویر",
    "agritech.filters.platform": "پلتفارم",
    "agritech.filters.platform_all": "ټول پلتفارمونه",
    "agritech.filters.search": "لټون",
    "agritech.filters.search_placeholder": "وسایل ولټوئ...",
    "agritech.results.count": "{count} وسایل وموندل شول",
    "agritech.empty.title": "هیڅ وسیله ونه موندل شوه",
    "agritech.empty.body":
        "ستاسو د فلټرونو له مخې هیڅ وسیله سمه نه ده. مهرباني وکړئ لټون بدلون ورکړئ.",
    "agritech.empty.clear": "فلټرونه پاک کړئ",
    "agritech.download": "ډاونلوډ",
    "agritech.coming_soon": "ژر",

    // Market Access Programs (list)
    "market.breadcrumb.home": "کور",
    "market.badge": "بازار موندنې حللارې",
    "market.title": "د بازار د لاسرسي پروګرامونه",
    "market.subtitle":
        "له بازارونو سره اړیکې، د ارزښت ځنځیرونو پیاوړتیا او پایدار شریکوالي د کرنیز ظرفیت او عاید د زیاتونې لپاره.",
    "market.stats.active": "فعال پروګرامونه",
    "market.stats.crops": "د حاصلاتو ډولونه",
    "market.stats.partners": "شریک سازمانونه",
    "market.scroll": "پروګرامونه لاندې وګورئ",
    "market.filters.title": "پروګرامونه فلټر کړئ",
    "market.filters.reset": "فلټرونه بیا تنظیم کړئ",
    "market.filters.type": "د پروګرام ډول",
    "market.filters.type_all": "ټول ډولونه",
    "market.filters.search": "لټون",
    "market.filters.search_placeholder": "پروګرامونه ولټوئ...",
    "market.results.count": "{count} پروګرامونه وموندل شول",
    "market.empty.title": "هیڅ پروګرام ونه موندل شو",
    "market.empty.body":
        "ستاسو د اوسني فلټرونو له مخې کوم پروګرام نشته. مهرباني وکړئ لټون بدل کړئ.",
    "market.empty.clear": "فلټرونه پاک کړئ",
    ...
    "training.badge": "مسلکي پرمختګ",
    "training.title": "د روزنې پروګرامونه",
    "training.subtitle":
        "زموږ هراړخیزې روزنیزې برنامې او د ظرفیت لوړولو نوښتونه په ټوله افغانستان کې وپلټئ. د عصري کرنې لپاره اړین مهارتونه زده کړئ.",
    "training.scroll": "ټول پروګرامونه لاندې وګورئ",
    "training.filters.title": "پروګرامونه فلټر کړئ",
    "training.filters.reset": "فلټرونه بیا تنظیم کړئ",
    "training.filters.status": "وضعیت",
    "training.filters.status_all": "ټول وضعیتونه",
    "training.filters.status_published": "خپر شوي",
    "training.filters.status_ongoing": "روان",
    "training.filters.status_completed": "بشپړ",
    "training.filters.location": "ځای",
    "training.filters.location_placeholder": "ځای ولیکئ...",
    "training.results.count": "{count} پروګرامونه وموندل شول",
    "training.empty": "هیڅ پروګرام ونه موندل شو.",
    "training.pagination.prev": "شاته",
    "training.pagination.next": "مخکې",
    "training.pagination.page_of": "{page} له {total} څخه پاڼه",
    "training.view_details": "تفصیلات وګورئ",

    // Training Program Detail
    "training.detail.badge": "د روزنې پروګرام",
    "training.detail.program_details": "د پروګرام جزئیات",
    "training.detail.duration": "موده",
    "training.detail.max_participants": "اعظمي ګډونوال",
    "training.detail.instructor": "ښوونکی",
    "training.detail.program_type": "د پروګرام ډول",
    "training.detail.overview": "د پروګرام لنډیز",
    "training.detail.overview_sub": "د روزنې بشپړ جزئیات او درسي پلان",
    "training.detail.learning_objectives": "د زده کړې موخې",
    "training.detail.course_syllabus": "درسي پلان",
    "training.detail.need_info": "نور معلومات غواړئ؟",
    "training.detail.need_info_sub":
        "د پروګرام جزئیاتو او نوم‌لیکنې لپاره له ټیم سره اړیکه ونیسئ.",
    ...
    // Loader translations
    "loader.home": "کوه آگرو ته ښه راغلاست",
    "loader.our_work": "زموږ اغېز کشف کړئ",
    "loader.training_programs": "د روزنې پروګرامونه چمتو کول",
    "loader.agri_tech": "د کرنې ټکنالوژي لوډ کول",
    "loader.market_access": "د بازار فرصتونه لاسرسی کول",
    "loader.smart_farming": "د پاملرنې حللارو سره تړاو",
    "loader.seed_supply": "د تخم د ورکړې معلومات چمتو کول",
    "loader.community_programs": "د ټولنې پروګرامونه لوډ کول",
    "loader.environmental_projects": "د چاپیریال پروژو ته لاسرسی",
    "loader.resources": "سرچینې راټولول",
    "loader.careers": "د دندو فرصتونه چمتو کول",
    "loader.contact": "د اړیکو معلومات لوډ کول",
    "loader.default": "پاڼه لوډ کېږي",
    "loader.sub_home": "د نوښتګرو کرنیزو حللارو او د دوامدارو کرنیزو چارو کشف",
    "loader.sub_our_work": "زموږ د افغانستان کې د کرنې بدلون ته ژمنتیا ښودل",
    "loader.sub_training_programs":
        "د پوهه شریکولو او ظرفیت لوړولو لپاره چمتو کیدل",
    "loader.sub_agri_tech":
        "د عصري کرنې لپاره د پرمختللو وسایلو او ټکنالوژیو وړاندې کول",
    "loader.sub_market_access": "د نویو فرصتونو او اړیکو لپاره دروازې پرانیستل",
    "loader.sub_smart_farming": "د سنتي کرنیزې پوهې سره ټکنالوژي یوځای کول",
    "loader.sub_seed_supply": "د غوره محصولاتو لپاره د کیفیت لرونکو نهادیو ډاډ",
    "loader.sub_community_programs": "د ټولنو سره تړاو او شریکونو جوړول",
    "loader.sub_environmental_projects":
        "د غوره راتلونکي لپاره د دوامدارو چارو ترویج",
    "loader.sub_resources": "د خپرونو، خبرونو او د بریالیتوب کیسو راټولول",
    "loader.sub_careers": "زموږ سره د ودې لپاره د مناسب استعداد موندل",
    "loader.sub_contact": "زموږ ټیم سره اړیکه",
    "loader.sub_default":
        "مهرباني وکړئ انتظار وکړئ ترڅو موږ ټول شیان تاسو لپاره چمتو کړو",
};
