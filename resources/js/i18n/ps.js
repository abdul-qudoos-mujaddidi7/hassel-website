export default {
    ...
    news: "خبرونه",
    publications: "خپرونې",
    success_stories: "د بریالیتوب کیسې",
    training_programs: "د روزنې پروګرامونه",
    contacts: "اړیکې",
    contentBasedOnAmountAndPercentage: "محتوا د مقدار او سلنې پر اساس",
    thisYear: "ددغه کال",
    thisMonth: "ددغه میاشت",
    today: "نن",
    recentContacts: "تازه اړیکې",
    noRecentContacts: "نورې تازه اړیکې نشته",
    contentTrends: "د محتوا روندونه",
    contentStatus: "د محتوا وضعیت",
    totalItems: "ټول توکي",
    name: "نوم",
    time: "وخت",
    phone: "تلیفون",
    uncategorized: "کټګوریزه نشوي",
    general: "عمومی",
    unknown: "نامعلوم",
};
